...
int main() {
  ...
  <div class="author__content">
    <hr><h3 class="author__name" style="font-size: .9rem !important;">Hendrick</h3>
    <p class="author__bio">Wuhan University</p>
  </div>
  <div class="author__urls-wrapper">
    <!-- <button class="btn btn--inverse">More Info & Contact</button> -->
    <ul class="author__urls social-icons" style="">
        <li><div style="white-space: normal; margin-bottom: 1.3em;">「Suffering is optional.」
        </div></li>
    </ul>
    <div style="display: flex; gap: 19px;">
    <a href="https://github.com/Nahtreom" title="github" class="social_icons" style="text-decoration: none; align-items: center;">
    ...
    <a href="mailto:yuhengwang0611@outlook.com" title="email" class="social_icons" style="text-decoration: none; align-items: center;">
